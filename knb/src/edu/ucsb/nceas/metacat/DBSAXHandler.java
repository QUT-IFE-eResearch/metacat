 ...
 *
 *   '$Author: tao $'
 *     '$Date: 2011-06-22 06:56:34 +1000 (Wed, 22 Jun 2011) $'
 * '$Revision: 6173 $'
 *
...
*/
            ...
            Attributes atts) throws SAXException
    {
		...
		try {
			...
			throw (new SAXException("Error in DBSaxHandler.startElement " + action+" : "+pnfe.getMessage()));
		}
	}               
    ...
    public void fatalError(SAXParseException exception) throws SAXException
    {
        ...
        throw (new SAXException("Fatal processing error: "+exception.getMessage()));
    }
