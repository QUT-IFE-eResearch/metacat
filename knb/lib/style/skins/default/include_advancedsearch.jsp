...
/**
  ...
  *
  *   '$Author: daigle $'
  *     '$Date: 2009-02-21 05:13:03 +1000 (Sat, 21 Feb 2009) $'
  * '$Revision: 4814 $'
  * 
  ...
  <table width="750px" align="center" cellspacing="0" cellpadding="0">
    <tr> 
      <td width="10" align="right" valign="top">
        <img src="<%=STYLE_SKINS_URL%>/default/images/panelhead_bg_lcorner.gif" 
          width="10" height="21">
      </td>
      ...
      <td width="10" align="left" valign="top"> 
        <img src="<%=STYLE_SKINS_URL%>/default/images/panelhead_bg_rcorner.gif" 
          width="10" height="21">
      </td>
    </tr>
    <tr> 
