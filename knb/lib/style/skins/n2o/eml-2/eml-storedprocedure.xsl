...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="storedProcedure" mode="afterInfo">
    <dl class="parameter section">
      <dt>Parameter</dt>
      <dd>
  ...
  <xsl:template match="parameter">
    <dl class="centity"><dt></dt>
      <dd>
        <dl><dt>Name:</dt><dd><xsl:value-of select="name"/></dd></dl>
        <dl><dt>Domain:</dt><dd><xsl:value-of select="domainDescription"/></dd></dl>
        <dl><dt>Required:</dt><dd><xsl:value-of select="required"/></dd></dl>
        <dl><dt>Repeatable:</dt><dd><xsl:value-of select="repeats"/></dd></dl>
      </dd>
    </dl>
  </xsl:template>
