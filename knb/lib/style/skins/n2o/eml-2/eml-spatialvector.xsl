...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="spatialVector" mode="lastInfo">
    <xsl:apply-templates select="geometry"/>
    <xsl:apply-templates select="geometricObjectCount"/>
    <xsl:apply-templates select="topologyLevel"/>
  ...
  <xsl:template match="geometry">
    <dl class="row"><dt>Geometry:</dt><dd><xsl:value-of select="."/></dd></dl>
  </xsl:template>
  <xsl:template match="geometricObjectCount">
    <dl class="row"><dt>Number of Geometric Objects:</dt><dd><xsl:value-of select="."/></dd></dl>
  </xsl:template>
  <xsl:template match="topologyLevel">
    <dl class="row"><dt>Topology Level:</dt><dd><xsl:value-of select="."/></dd></dl>
  </xsl:template>
