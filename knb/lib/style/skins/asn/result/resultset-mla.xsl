  ...
  <xsl:template match="/">
    <html>
      ...
      <body>
        ...
        <div class="templatetableclass">
          <div class="templateheaderrowclass">
        &incheader;
         </div>
          <div class="templatecontent">
            <div style="overflow:auto;">
            <div class="templateleftcolclass left">
              &incside;
              </div>
			<div class="templatecontentareaclass templatetableclass">
                  <div class="iframesearchboxclass">RELRP Data Catalogue
                 	 &incsearchbox;
                  </div>
