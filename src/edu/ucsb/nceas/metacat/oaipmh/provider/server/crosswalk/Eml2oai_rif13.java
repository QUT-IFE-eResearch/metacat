...
/**
 * Convert native "item" to oai_rif v1.3. In this case, the native "item" is assumed
 ...
 * requested.
 */
public class Eml2oai_rif13 extends Crosswalk {
  
  /* Class fields */

  
  private static String dirPath = null;
  private static final String XSLT_NAME_210_RIFCS13 = "eml210toRifCs13.xsl";
  ...
  private Transformer transformer210RIFCS13 = null;
   ...
   */
  public Eml2oai_rif13(Properties properties) throws OAIInternalServerError {
    super(SCHEMA_LOCATION);
    String xsltPath210 = dirPath + "/" + XSLT_NAME_210_RIFCS13;
    ...
    try {
      ...
      this.transformer210RIFCS13 = tFactory210.newTransformer(xslSource210);
      this.transformer210RIFCS13.setParameter("groupName", propertyService.getProperty("rifcs.groupname"));
      this.transformer210RIFCS13.setParameter("metacat-server-url", "http://"+propertyService.getProperty("server.name")+"/"+propertyService.getProperty("application.context")+"/metacat");
      this.transformer210RIFCS13.setParameter("metacat-server", propertyService.getProperty("server.name"));
      this.transformer210RIFCS13.setParameter("qformat", propertyService.getProperty("application.default-style"));
      this.transformer210RIFCS13.setParameter("originatingSource", "http://"+propertyService.getProperty("server.name"));
  ...
  public static void setDirPath(String configDir) {
    Eml2oai_rif13.dirPath = configDir;
  }
  ...
  public String createMetadata(Object nativeItem)
    ...
    try {
      ...
      transformer = transformer210RIFCS13;
      
      StringReader stringReader = new StringReader(xmlRec);
      StreamSource streamSource = new StreamSource(stringReader);
      StringWriter stringWriter = new StringWriter();
      synchronized (transformer) {
    	transformer.setParameter("lastModifed", recordMap.get("lastModified"));
        transformer.transform(streamSource, new StreamResult(stringWriter));
        transformer.setParameter("lastModifed", "");
      }
